defmodule Dust.Sync.ConflictTest do
  ...
  # Paths in this module are canonical slash-rendered strings — the
  # same shape the writer/SQL uses post-segment-first migration.
  # Keys with literal `.` (legacy callers wrote dotted concatenations)
  # show up here as single segments.
