defmodule Dust.WorkOSClient.Default do
  @moduledoc """
  Default `Dust.WorkOSClient` implementation. Hits AuthKit's standard OAuth 2.0
  endpoints (`/oauth2/token` and `/oauth2/userinfo`) directly via Req so we can
  send PKCE verifiers and route through the dedicated MCP client_id.
  """
